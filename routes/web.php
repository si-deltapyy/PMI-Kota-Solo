...
Route::group(['middleware' => ['auth', 'role:relawan']], function () {
    ...
    Route::delete('/relawan/laporan-kejadian/{id}/delete', [RelawanController::class, 'delete_laporankejadian'])->name('delete-laporankejadian'); //edit
    ...
    Route::delete('/relawan/assesment/{id}/delete', [RelawanController::class, 'delete_assessment'])->name('delete-assessment'); //edit
});
