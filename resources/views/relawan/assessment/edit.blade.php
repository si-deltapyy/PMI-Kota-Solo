...
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <h4 class="card-title">Edit Laporan Assesment</h4>
                  <p class="card-description">
                    Edit laporan assesment
                  </p> 
                  <div class="home-tab">
                  ...
                  <!-- <form class="forms-sample">
                    ...
                    <div class="btn-wrapper">
                      ...
                      <a href="#" class="btn btn-primary text-white me-0" data-bs-toggle="modal" data-bs-target="#generateModal"><i class="mdi mdi-table-edit"></i> Edit</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Apakah anda yakin ingin mengedit laporan assesment?</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">Klik "Submit" dibawah ini jika ingin mengedit Laporan Assesment</div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-black" data-bs-dismiss="modal">Cancel</button>
                                        <a class="btn btn-primary text-white me-0" href="{{ route('relawan-laporankejadian') }}">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
