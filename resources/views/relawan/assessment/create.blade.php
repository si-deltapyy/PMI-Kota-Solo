        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif --}}
                    <form action="{{ url('/relawan/assessment/store') }}" method="POST" class="forms-sample"
                        ...
                        {{-- <input type="hidden" name="id_admin"
                            value="{{User::role('admin')->inRandomOrder()->first()}}"> --}}
                        <div class="form-group">
                            <label for="kejadian_musibah">Jenis Kejadian Bencana</label>
                            <input type="text" class="form-control" value="{{ $jeniskejadian->nama_kejadian }}"
                                readonly>
                        </div>

                        <div class="form-group">
                            <label for="waktu_kejadian">Tanggal Kejadian</label>
                            <input type="date" class="form-control" id="waktu_kejadian" name="tanggal_kejadian"
                                value="{{ $kejadian->tanggal_kejadian }}" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="meninggalevakuasi"
                                    name="meninggalevakuasi">
                            </div>
                            <div class="form-group">
                                <label for="keterangan">Keterangan</label>
                                <input type="text" class="form-control" id="keterangan_evakuasi"
                                    name="keterangan_evakuasi">
                            </div>
                        ...
                        <div class="form-group d-flex justify-content-end">
                            ...
                            <a href="{{ route('relawan-assessment', $kejadian->id_kejadian) }}"
                                class="btn btn-light ml-3">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
