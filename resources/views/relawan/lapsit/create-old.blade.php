                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('create-lapsit.store', $kejadian->id_kejadian) }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <!--select name="id_jeniskejadian" id="id_jeniskejadian" class="js-example-basic-single w-100" required>
                                        @foreach($kejadian as $kejadian) 
                                        
                                        @endforeach
                                    </select-->
                                    <select name="id_jeniskejadian" id="id_jeniskejadian" class="form-control form-control-sm" placeholder="- Pilih Jenis Kejadian -" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lokasi" id="lokasi" value="{{$kejadian->lokasi}}" placeholder="Lokasi" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="tanggal_kejadian">Waktu Kejadian</label>
                                    <input type="date" class="form-control" name="tanggal_kejadian" id="tanggal_kejadian" placeholder="Waktu Kejadian" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="file_dokumentasi" class="file-upload-default" id="file_dokumentasi" accept=".jpg, .jpeg, .png" multiple>
                                ...
                                <div id="form_area">
                                    <div id="form_pengungsian" style="display:none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="atr_5_sampai_18" name="atr_5_sampai_18">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div id="form_area_petugas">
                                    <div id="form_petugas" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_lengkap_petugas" name="nama_lengkap_petugas">
                                        </div>
                                        <div class="form-group">
                                            <label for="kontak_petugas">Kontak</label>
                                            <input type="phone" class="form-control" id="kontak_petugas" name="kontak_petugas">
                                        </div>
                                    </div>
                                </div>
