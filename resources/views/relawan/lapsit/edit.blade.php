                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('edit-lapsit.update', $kejadian->id_assessment) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="dukungan_internasional" name="dukungan_internasional" style="background-color: white; color: black;">
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="staf_markas_kabkota" name="staf_markas_kabkota" value="{{ $kejadian->mobilisasiSd?->personil?->staf_markas_kabkota ?? '' }}">
                                </div>

                                <div class="form-group">
                                    <label for="staf_markas_prov">Staf Markas Provinsi</label>
                                    <input type="number" class="form-control" id="staf_markas_prov" name="staf_markas_prov" value="{{ $kejadian->mobilisasiSd?->personil?->staf_markas_prov ?? '' }}">
                                </div>

                                <div class="form-group">
                                    <label for="staf_markas_pusat">Staf Markas Pusat</label>
                                    <input type="number" class="form-control" id="staf_markas_pusat" name="staf_markas_pusat" value="{{ $kejadian->mobilisasiSd?->personil?->staf_markas_pusat ?? '' }}">
                                </div>

                                <div class="form-group">
                                    <label for="relawan_pmi_kabkota">Relawan PMI Kab/Kota</label>
                                    <input type="number" class="form-control" id="relawan_pmi_kabkota" name="relawan_pmi_kabkota" value="{{ $kejadian->mobilisasiSd?->personil?->relawan_pmi_kabkota ?? '' }}">
                                </div>

                                <div class="form-group">
                                    <label for="relawan_pmi_prov">Relawan PMI Provinsi</label>
                                    <input type="number" class="form-control" id="relawan_pmi_prov" name="relawan_pmi_prov" value="{{ $kejadian->mobilisasiSd?->personil?->relawan_pmi_prov ?? '' }}">
                                </div>

                                <div class="form-group">
                                    <label for="relawan_pmi_linprov">Relawan PMI Lintas Provinsi</label>
                                    <input type="number" class="form-control" id="relawan_pmi_linprov" name="relawan_pmi_linprov" value="{{ $kejadian->mobilisasiSd?->personil?->relawan_pmi_linprov ?? '' }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="giat_pemerintah" id="giat_pemerintah" value="{{ $kejadian->giat_pemerintah }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="hambatan" id="hambatan" value="{{ $kejadian->hambatan }}">
                                </div>
                                ...
                                <div id="form_area_cp">
                                    <button type="button" class="btn btn-primary" id="add-petugas-posko">Input Petugas Posko</button>
                                    <br>
                                        ...
                                        @if($kejadian->petugasPosko->isNotEmpty())
                                            @foreach($kejadian->petugasPosko as $index => $petugasPosko)
                                                <div class="petugas-posko-item mb-3">
                                                    ...
                                                    <input type="hidden" name="petugasPosko[{{ $index }}][id_petugas_posko]" value="{{ $petugasPosko->id_petugas_posko }}">
                                                    <div class="form-group">
                                                        <label for="nama_lengkap_{{ $index }}">Nama Lengkap</label>
                                                        <input type="text" class="form-control" name="petugasPosko[{{ $index }}][nama_lengkap]" id="nama_lengkap_{{ $index }}" value="{{ $petugasPosko->nama_lengkap }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="kontak_{{ $index }}">Kontak</label>
                                                        <input type="phone" class="form-control" name="petugasPosko[{{ $index }}][kontak]" id="kontak_{{ $index }}" value="{{ $petugasPosko->kontak }}">
                                                    </div>
                                ...
                                <div id="dokumentasi-container">
                                    ...
                                    <input type="hidden" name="dokumentasi[{{ $index }}][id_dokumentasi]" value="{{ $dokumentasi->id_dokumentasi }}">
                                    <input type="hidden" name="dokumentasi[{{ $index }}][delete]" class="delete-flag" value="0">
                                    <input type="file" name="dokumentasi[{{ $index }}][file_dokumentasi]" class="file-upload-default" style="display: none;">
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled value="{{ $dokumentasi->file_dokumentasi }}">
