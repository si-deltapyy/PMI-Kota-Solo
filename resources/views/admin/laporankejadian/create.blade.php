                      ...
                      @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="number" step="any" class="form-control form-control-sm" id="lokasi_longitude" name="lokasi_longitude" placeholder="Longitude" required>
                                </div>

                                <!-- Lokasi Latitude -->
                                <div class="form-group">
                                    <label for="lokasi_latitude">Lokasi Latitude</label>
                                    <input type="number" step="any" class="form-control form-control-sm" id="lokasi_latitude" name="lokasi_latitude" placeholder="Latitude" required>
                                </div>
                                <div class="form-group">
