        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('admin-verif-assessment', $assessment->id_assessment) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <button type="submit" class="btn btn-primary active">Verify</button>
                    </form>
                </div>
            </div>
        </div>
