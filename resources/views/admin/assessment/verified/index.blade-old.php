                ...
                <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal" data-document-id="1"><i class="menu-icon mdi mdi-information"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>2</td>
                        ...
                        <td><p class="btn btn-success btn-sm">Terkonfirmasi</p></td>
                        <td>
                        <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal" data-document-id="2"><i class="menu-icon mdi mdi-information"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>3</td>
                        ...
                        <td><p class="btn btn-success btn-sm">Terkonfirmasi</p></td>
                        <td>
                        <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal" data-document-id="3"><i class="menu-icon mdi mdi-information"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>4</td>
                        ...
                        <td><p class="btn btn-success btn-sm">Terkonfirmasi</p></td>
                        <td>
                            <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal" data-document-id="4"><i class="menu-icon mdi mdi-information"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>5</td>
                        ...
                        <td><p class="btn btn-success btn-sm">Terkonfirmasi</p></td>
                        <td>
                            <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal" data-document-id="5"><i class="menu-icon mdi mdi-information"></i></a>
                        </td>
                    </tr>
                      </tbody>
                    </table>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="refugeeRadios" id="refugeeRadios1" value="" checked disabled>
                                    Ada
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="refugeeRadios" id="refugeeRadios2" value="option2" disabled>
                                    Tidak
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="streetRadios" id="streetRadios1" value="" checked disabled>
                                    Berfungsi
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="streetRadios" id="streetRadios2" value="option2" disabled>
                                    Tidak Berfungsi
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="bridgeRadios" id="bridgeRadios1" value="" checked disabled>
                                    Berfungsi
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="bridgeRadios" id="bridgeRadios2" value="option2" disabled>
                                    Tidak Berfungsi
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="vehicleRadios" id="vehicleRadios1" value="" checked disabled>
                                    Berfungsi
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="vehicleRadios" id="vehicleRadios2" value="option2" disabled>
                                    Tidak Berfungsi
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group row">
                              <div class="col-sm-3">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="transportRadios" id="transportRadios1" value="" checked disabled>
                              ...
                              <div class="col-sm-3">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="transportRadios" id="transportRadios2" value="option2" disabled>
                                    Telepon Selular
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-3">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="transportRadios" id="transportRadios3" value="option2" disabled>
                                    Kantor Pos
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-3">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="transportRadios" id="transportRadios4" value="option2" disabled>
                                    Internet
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="hospitalRadios" id="hospitalRadios1" value="" checked disabled>
                                    Berfungsi
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="hospitalRadios" id="hospitalRadios2" value="option2" disabled>
                                    Tidak Berfungsi
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="elecRadios" id="elecRadios1" value="" checked disabled>
                                    Berfungsi
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="elecRadios" id="elecRadios2" value="option2" disabled>
                                    Tidak Berfungsi
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="waterRadios" id="waterRadios1" value="" checked disabled>
                                    Berfungsi
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="waterRadios" id="waterRadios2" value="option2" disabled>
                                    Tidak Berfungsi
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="schoolRadios" id="schoolRadios1" value="" checked disabled>
                                    Berfungsi
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="schoolRadios" id="schoolRadios2" value="option2" disabled>
                                    Tidak Berfungsi
                                  </label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="worshipFacRadios" id="worshipFacRadios1" value="" checked disabled>
                                    Berfungsi
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-5">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="worshipFacRadios" id="worshipFacRadios2" value="option2" disabled>
                                    Tidak Berfungsi
                                  </label>
                                </div>
                              </div>
