                ...
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  ...
                  <div>
                    <div class="btn-wrapper">
                      ...
                      <a href="#" class="btn btn-primary text-white me-0" data-bs-toggle="modal" data-bs-target="#generateModal"><i class="icon-download"></i> Generate Executive Summary</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Do you want to generate Executive Summary?</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">Select "Generate" below if you want to generate & download Executive Summary.</div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-black" data-bs-dismiss="modal">Cancel</button>
                                        <a class="btn btn-primary text-white me-0" href="login.html">Generate</a>
                                    </div>
                                </div>
                            </div>
                        </div>
